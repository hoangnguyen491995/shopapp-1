                        ...
                        <div class="col-md-8">
                            ...
                            <c:forEach var="item" items="${products}">
                                <div
                                    ...
                                    <div class="mr-1"><img class="rounded" src="https://i.imgur.com/XiFJkhI.jpg"
                                            width="70"></div>
                                    ...
                                    <div class="d-flex align-items-center"> <a href="/cart/delete-product?productId=${item.productId}"><i class="fa fa-trash mb-1 text-danger"></i></a>
                                    </div>
                                </div>
                            </c:forEach>
                            <div class="d-flex flex-row align-items-center mt-3 p-2 bg-white rounded"><button
                                    class="btn btn-warning btn-block btn-lg ml-2 pay-button" type="button">Mua
                                    Hàng</button></div>
                        </div>
                    </div>
                </div>
