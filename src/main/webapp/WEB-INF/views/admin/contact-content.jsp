<%-- Created by IntelliJ IDEA. User: hoangnd3 Date: 11/24/2022 Time: 11:10 AM To
  ...
  <body>
    <div class="admin_dashboard">
      <div class="item_dashboard">
       ...
       <br> 
        <input style="outline: none;border:none;background-color:#ebef6d ; " id="myAccount_admin_contact">  
     </input>         
   </div>
        ...
        <div class="table-responsive">
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                <div class="col-sm-6">
                  <h2>Quản Lí <b>Thông Tin liên Hệ</b></h2>
                </div>
            ...
            <form>
              ...
              <div class="modal-body">
                <div class="form-group">
                  <label>ID Liên Hệ: </label>
                  <label id="detailContactId" for=""></label>
                </div>
                <div class="form-group">
                  <label>Thời Gian Tạo Lời Nhắn: </label>
    ...
    <script src="/js/contact-content.js"></script>
  </body>
</html>
