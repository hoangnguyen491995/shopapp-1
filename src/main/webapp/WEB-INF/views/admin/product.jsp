...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        <%-- Created by IntelliJ IDEA. User: hoangnd3 Date: 12/24/2022 Time: 11:03 AM To change this template use File |
                            ...
                            <div class="modal-content">
                                <form:form method="POST" modelAttribute="product">
                                    ...
                                    <div class="modal-footer">
                                        <form:input type="button" class="btn btn-default" data-dismiss="modal"
                                            value="Cancel"/>
                                        <form:input type="submit" class="btn btn-success" value="Add" />
                                    </div>
                                </form:form>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                <form:form>
                                    ...
                                    <div class="modal-footer">
                                        <form:input type="button" class="btn btn-default" data-dismiss="modal"
                                            value="Quay lại"/>
                                        <form:input type="submit" class="btn btn-info" value="Lưu"/>
                                    </div>
                                </form:form>
                            </div>
                        </div>
